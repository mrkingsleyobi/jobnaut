    ...
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-2xl">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleLogin">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <NuxtLink to="/auth/forgot-password" class="font-medium text-blue-600 hover:text-blue-500 transition duration-150">
              Forgot password?
            </NuxtLink>
          </div>
        </div>
      ...
      <div class="text-center">
        <p class="text-sm text-gray-600">
          ...
          <NuxtLink to="/auth/signup" class="font-medium text-blue-600 hover:text-blue-500 transition duration-150">
            Sign up
          </NuxtLink>
        </p>
      </div>
